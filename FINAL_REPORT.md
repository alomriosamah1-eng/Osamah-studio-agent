...
بعد إغلاق شريحة Local Provider Adapters، الخطوة التقنية التالية هي provider configuration وdoctor/resource/quota contracts ثم ربط adapters بمسار planner/critic. يأتي backup UX وencryption/key management عند الحاجة، مع إبقاء استكمال Lightweight Web Preview إلى آخر مراحل تصميم البيئة.
...
إعداد: Manus AI. تاريخ التحديث: 2026-08-22. آخر delivery: `c18b6befcaf82acc4679f9ed72899659d00d6a11`؛ `GITHUB_PUSH_VERIFIED=true`.
