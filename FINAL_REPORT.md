...
بعد إغلاق شريحة Context وAgent Task Review Panel، الخطوة التقنية التالية هي بقية Development Environment أو Production Studio وفق أولوية المالك، ثم Second Brain، مع إبقاء provider persistence وstreaming وtool execution وLightweight Web Preview ضمن المراحل اللاحقة.
...
إعداد: Manus AI. تاريخ التحديث: 2026-08-22. Feature delivery الحالي: `665fe76a44963736881f6f2ed519d95a2b901825`؛ docs-close delivery قيد commit/push والتحقق النهائي.
