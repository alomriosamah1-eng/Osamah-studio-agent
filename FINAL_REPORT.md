...
| GitHub push verification | `cb70b17f1b5d9350e22855bf8da98efd0f8eb226`؛ local وremote متطابقان |
...
بعد إغلاق شريحة Typed Provider Configuration UI/IPC، الخطوة التقنية التالية هي ربط adapters بمسار Planner/Critic وAgent Runtime مع provider/model selection typed وHuman Gate قبل mutation.
...
إعداد: Manus AI. تاريخ التحديث: 2026-08-22. آخر delivery: `cb70b17f1b5d9350e22855bf8da98efd0f8eb226`؛ Typed Provider Configuration UI/IPC مدفوعة ومتحقق منها، local == `origin/main`.
