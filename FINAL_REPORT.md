...
بعد إغلاق شريحة Audit Export وRetention Policy، الخطوة التقنية التالية هي planner/critic contracts ثم provider adapters الفعلية. يأتي backup UX وencryption/key management عند الحاجة، مع إبقاء استكمال Lightweight Web Preview إلى آخر مراحل تصميم البيئة.
