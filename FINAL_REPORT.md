...
| Provider Policy/Doctor/Quota | configuration وdisabled/blocked/healthy doctor وconcurrency/rate/circuit وGateway admission؛ delivery pending commit |
...
بعد إغلاق شريحة Provider Policy/Doctor/Quota، الخطوة التقنية التالية هي typed provider configuration UI/IPC ثم ربط adapters بمسار planner/critic.
...
إعداد: Manus AI. تاريخ التحديث: 2026-08-22. آخر delivery: `c18b6befcaf82acc4679f9ed72899659d00d6a11`؛ Provider Policy/Doctor/Quota قيد commit/push.
