...
بعد أي تعديل تالٍ نفّذ secret scan الموجود في المشروع، ثم `git status --short`، ثم commit، ثم `git push origin main`، ثم `git rev-parse HEAD` و`git ls-remote origin refs/heads/main` وتحقق من تطابق القيمتين. آخر delivery مكتمل هو `d989960112307b92185f18d1046506a620460887`؛ Terminal Policy Preview قيد commit/push.
...
بعد إغلاق Terminal Policy Preview، تأتي شريحة Git/read-only integration وفق الترتيب المعتمد، ثم Production Studio وSecond Brain.
...
إعداد: Manus AI. آخر تحديث: 2026-08-22. آخر delivery: `d989960112307b92185f18d1046506a620460887`؛ Terminal Policy Preview قيد commit/push.
