...
نتيجة الاختبار الحالية: `pnpm check` يمر بـ`124/124` اختبارًا. Full gate لشريحة Terminal Policy Preview يمر مع build وdesktop/performance smoke وSQLite/JSON/diff/secret validation، ودفع GitHub متحقق عند `18b980a4e3b76de01e919c959a5771e8a67475a9`، ولا توجد network calls أو model loading أو child process عند startup أو أثناء inspect.
...
إعداد: Manus AI. آخر تحديث: 2026-08-22. آخر delivery: `18b980a4e3b76de01e919c959a5771e8a67475a9`؛ Terminal Policy Preview مدفوعة ومتحقق منها، local == `origin/main`.
