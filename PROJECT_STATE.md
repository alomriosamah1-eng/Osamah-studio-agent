...
| آخر فحص | full gate بعد agent scope ناجح؛ `pnpm check` بـ`208/208`، build وdesktop/performance smoke وSQLite/JSON/Node syntax/diff/secret validation PASS؛ log في `research/memory-agent-scope-full-gate-output-2026-08-22.txt` |
...
| composition SQLite | opt-in/restart/fallback/close lifecycle وmigration 006 وMemoryEntry links وagent scope restart/fail-closed PASS |
