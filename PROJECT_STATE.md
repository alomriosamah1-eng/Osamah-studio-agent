...
| الحالة | Ollama وllama.cpp adapters منفذة ومدفوعة ومربوطة اختياريًا بالـGateway ومتحقق منها على `origin/main`؛ الخطوة التالية provider configuration وdoctor/resource/quota contracts |
...
| آخر فحص | `pnpm check` ناجح، `92/92` اختبارًا؛ full gate وGitHub verification ناجحتان في 2026-08-22 |
