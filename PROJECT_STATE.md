...
| آخر فحص | آخر full gate معروف ناجح؛ `pnpm check` بـ`181/181`، build وdesktop/performance smoke وSQLite/JSON/diff/secret validation وSettings IPC/Electron smoke PASS؛ يجب إعادة التحقق بعد docs-only changes |
