...
| الحالة | Provider/Approval وProviderGateway منفذة ومدفوعة ومتحقق منها على `origin/main`؛ الخطوة التالية agent work cycle |
...
| آخر فحص | `pnpm check` ناجح، `63/63` اختبارًا، وbuild/desktop/performance/static gates وGitHub verification ناجحة في 2026-08-22 |
