...
| آخر فحص | full gate بعد Markdown export ناجح؛ `pnpm check` بـ`209/209`، build وdesktop/performance smoke وSQLite/JSON/Node syntax/diff/secret validation PASS؛ log في `research/markdown-export-full-gate-output-2026-08-22.txt` |
