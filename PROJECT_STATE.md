...
دراسة Virtual Human داخل Second Brain أُغلقت توثيقيًا فقط في docs `84–86`، مع roadmap 0–11 وLicense Matrix وstate/event design وprivacy/performance budget. لا يبدأ تنفيذها أو تثبيت حزم/نماذج أو تغيير Electron/TypeScript/typed IPC إلا بعد قرار مالك منفصل. أُغلقت local lexical retrieval والروابط وscope/visibility filtering؛ أثبت runtime أن FTS5 غير متوفر. أُضيف OpenCode SDK ثم Hermes ACP worker فعليًا خلف adapters، بينما DeepSeek Harness هو المسار التالي لمراجعة plugin/event bridge. تبقى embeddings/vector services وOAuth/MCP/Playwright/tunnels خلف gates مستقلة.
