...
**Feature documentation commit:** `7ede715dfbd8f9e4d030848573b11e94790ba580`؛ تم دفعه والتحقق من تطابقه مع `origin/main`. إغلاق توثيقي مستقل سيأتي بعد تحديث ملفات الحالة.
