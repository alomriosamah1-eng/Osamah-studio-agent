...
هذه المجلدات هي **مصدر الحقيقة الهندسي** لمشروع Osamah Studio Agent. المشروع في مرحلة Discovery، والمستودع بدأ فارغًا؛ لذلك تميّز الوثائق بين الحقائق المثبتة والقرارات المقترحة والافتراضات غير المحسومة.
