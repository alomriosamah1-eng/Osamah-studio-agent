...
const child = spawn(electronPath, ["dist/desktop/main.js"], {
  env: { ...process.env, OSAMAH_SMOKE: "1", OSAMAH_DISABLE_GPU: "1" },
...
child.on("close", (code, signal) => {
  ...
  if (code !== 0 || !output.includes("Osamah Studio Agent desktop shell ready.") || !output.includes("DESKTOP_IPC_SMOKE=PASS")) {
