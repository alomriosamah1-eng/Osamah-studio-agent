...
بعد إغلاق Arabic-first Settings، تبدأ الشريحة التقنية التالية إكمال localization resources أو metadata-only External Accounts أو Storage Settings أو Self-development Candidate Review؛ تبقى OAuth/MCP/Playwright/tunnels خلف gates مستقلة، ولا تُضاف persistence أو embeddings أو skill activation تلقائيًا.
