...
| Self-development | `docs/89-self-development-candidate-review.md`؛ `IMPLEMENTED / REVIEW-ONLY BOUNDED`، المرشح يبدأ `review_required`، والتفعيل صريح للمرشح النظيف فقط، feature `d35084225c3444608653e87b9a46c76e11c28d06` متحقق local==remote، docs-close قيد الإعداد |
