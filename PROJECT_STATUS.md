...
| External Accounts | `docs/87-external-accounts-metadata-only.md`؛ `IMPLEMENTED / METADATA-ONLY`، feature `1b7d9df2d997776fe5453c7d8ea7c4e4c8fc3a4b` متحقق local==remote، docs-close قيد الإعداد |
