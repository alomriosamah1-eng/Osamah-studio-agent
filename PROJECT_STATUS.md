...
| Relational Memory Links | `docs/93-memory-relational-links-bounded.md`؛ `IMPLEMENTED / BOUNDED DIRECTED LINKS`، migration 006 وrelations ثابتة وtarget/visibility validation وfail-closed hydration، feature `b4658e22690cc1b69d43fc1d25c5cffa6f72844d` متحقق local==remote، docs-close قيد الإعداد |
