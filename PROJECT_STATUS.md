...
| حالة الشجرة | Terminal Policy bounded وterminal.inspect وWorkspace Inspect-only panel منفذة ومدفوعة ومتحقق منها عند `18b980a4e3b76de01e919c959a5771e8a67475a9` |
| الإصدار المحلي | `0.6.0`؛ لا يوجد bump إصدار release في هذه الشريحة |
| آخر فحص مكتمل | `pnpm check` ناجح، `124/124` اختبارًا؛ full gate وGitHub verification للشريحة الحالية ناجحان في 2026-08-22 |
