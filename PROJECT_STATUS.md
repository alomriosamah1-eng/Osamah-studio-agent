...
| Storage Settings | `docs/88-storage-settings-read-only.md`؛ `IMPLEMENTED / READ-ONLY SNAPSHOT`، لا نقل أو حذف أو backup/restore من UI، docs-close قيد الإعداد |
