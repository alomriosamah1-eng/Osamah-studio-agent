...
| Visibility-filtered Retrieval | `docs/92-memory-local-retrieval-bounded.md`؛ `IMPLEMENTED / EXACT VISIBILITY FILTER`، المرشح private/workspace/project فقط، typed validation وfail-closed دون توسيع الوصول، feature `cf3227331384ab2f5b5b126fb0cf381c6ea8b8f1` متحقق local==remote، docs-close قيد الإعداد |
